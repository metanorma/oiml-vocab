...
# Aggregate `datasets/g18-complete/concepts/*.yaml` (already extracted by the manual
# agent pass) into `datasets/g18-complete/register.yaml` and `datasets/g18-complete/bibliography.yaml`.
#
...
# agents per TODO.consolidate/01-g18-complete-extraction-spec.md.
...
V0_DIR = File.join(REPO_ROOT, "datasets", "g18-complete")
